...
const DEFAULT_RULES: PricingRule[] = [
    { provider: 'openai', model: 'gpt-5-mini', currency: 'USD', inputPerMillion: 0.25, outputPerMillion: 2.0 },
    { provider: 'google', model: 'gemini-2.5-flash', currency: 'USD', inputPerMillion: 0.3, outputPerMillion: 2.5 },
    { provider: 'google', model: 'gemini-2.5-pro', currency: 'USD', inputPerMillion: 1.25, outputPerMillion: 10.0 },
    { provider: 'anthropic', model: 'claude-sonnet-4', currency: 'USD', inputPerMillion: 3.0, outputPerMillion: 15.0 },
    { provider: 'anthropic', model: 'claude-3-7-sonnet', currency: 'USD', inputPerMillion: 3.0, outputPerMillion: 15.0 },
    { provider: 'anthropic', model: 'claude-3-5-haiku', currency: 'USD', inputPerMillion: 0.8, outputPerMillion: 4.0 },
    { provider: 'anthropic', model: 'claude-haiku-4-5', currency: 'USD', inputPerMillion: 1.0, outputPerMillion: 5.0 },
    { provider: 'minimax', model: 'minimax-m2.5', currency: 'USD', inputPerMillion: 0.3, outputPerMillion: 1.2 },
    { provider: 'minimax', model: 'minimax-m2.5-highspeed', currency: 'USD', inputPerMillion: 0.6, outputPerMillion: 2.4 },
    { provider: 'minimax', model: 'minimax-m2.1', currency: 'USD', inputPerMillion: 0.3, outputPerMillion: 1.2 },
    { provider: 'minimax', model: 'minimax-m2.1-highspeed', currency: 'USD', inputPerMillion: 0.6, outputPerMillion: 2.4 },
    { provider: 'minimax', model: 'minimax-m2', currency: 'USD', inputPerMillion: 0.3, outputPerMillion: 1.2 },
    { provider: 'volcengine', model: 'doubao-seed-code', currency: 'CNY', inputPerMillion: 1.2, outputPerMillion: 8.0 },
    { provider: 'zhipu', model: 'glm-4-plus', currency: 'CNY', inputPerMillion: 5.0, outputPerMillion: 5.0 },
    { provider: 'zhipu', model: 'charglm-4', currency: 'CNY', inputPerMillion: 1.0, outputPerMillion: 1.0 },
    { provider: 'zhipu', model: 'glm-4v-plus-0111', currency: 'CNY', inputPerMillion: 4.0, outputPerMillion: 4.0 },
    { provider: 'deepseek', model: 'deepseek-chat', currency: 'USD', inputPerMillion: 0.27, outputPerMillion: 1.1 },
    { provider: 'deepseek', model: 'deepseek-reasoner', currency: 'USD', inputPerMillion: 0.55, outputPerMillion: 2.19 },
    { provider: 'dashscope', model: 'qwen2.5-7b-instruct', currency: 'CNY', inputPerMillion: 0.5, outputPerMillion: 1.0 },
    { provider: 'dashscope', model: 'qwen2.5-72b-instruct', currency: 'CNY', inputPerMillion: 4.0, outputPerMillion: 12.0 },
    { provider: 'dashscope', model: 'deepseek-r1', currency: 'CNY', inputPerMillion: 4.0, outputPerMillion: 16.0 },
]
