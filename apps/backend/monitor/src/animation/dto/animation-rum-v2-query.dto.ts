...
const SCOPES = ['page', 'target'] as const
...
export class AnimationRumV2QueryDto extends AnimationRumV2ApplicationDto {
    @IsOptional()
    @IsString()
    @Length(20, 24)
...
export class AnimationRumV2CapturesQueryDto extends AnimationRumV2QueryDto {
    @IsOptional()
    @Type(() => Number)
    @IsInt()
    @Min(1)
...
export class AnimationRumV2CaptureParamsDto {
    @IsString()
    @Length(8, 80)
