...
- packaged Vue/Angular/Svelte/Solid ownership/update adapters, deep React component ownership and independently measured commit work, and broader GSAP/Lenis/ScrollTrigger lifecycle/ticker integration; the React package now provides an anonymous public-Profiler subtree wrapper, while the generic framework and GSAP helpers still require explicit host wiring;
