...
export * from './framework-component-scope'
export * from './local-evidence'
...
export * from './video-presentation-evidence'
...
export { createAnimationRumV2MediaStageRegistry } from './rum-v2/media-stage-source'
export type * from './rum-v2/types'
export { toAnimationRumV3SoftNavigationReport } from './rum-v3/report-builder'
export type * from './rum-v3/types'
