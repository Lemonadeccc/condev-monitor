...
The bundled generic and fixture scenarios select catalog v3. Catalogs v1 and v2 retain their exact producer shapes, and catalog v3 requires a version-aligned Runner and Monitor.
