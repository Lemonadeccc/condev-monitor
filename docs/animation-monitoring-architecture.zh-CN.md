...
- 下一阶段是把显式 helper 接入真实应用/框架 adapter，并补 Vue/Angular/Svelte/Solid 宿主归因、renderer 资源/传输与内部对象归因、heap/route soak、decode/upload/first-visible 等深层证据；
